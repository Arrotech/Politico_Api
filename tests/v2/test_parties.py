...
from app import bad_request, method_not_allowed
from utils.dummy import party_bad_request, edit_party, party_logoUrl_value, party_hqAddress_exists, party_logoUrl_exists, \
    party_hqAddress_value, party_name_exists, create_party2, create_account, user_login, \
    party_name_keys, party_name_value
...
class TestOffice(BaseTest):
    ...
    def test_party_logoUrl_value(self):
        ...
        response1 = self.client.post(
            '/api/v2/parties', data=json.dumps(party_logoUrl_value), content_type='application/json',
            headers=self.get_token())
    ...
    def test_party_name_exists(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_token())
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_name_exists), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_party_hqAddress_exists(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_token())
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_hqAddress_exists), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_party_logoUrl_exists(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_token())
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_logoUrl_exists), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_unexisting_party(self):
        ...
        response1 = self.client.get(
            '/api/v2/parties/500', content_type='application/json', headers=self.get_token())
        result = json.loads(response1.data.decode())
        self.assertEqual(result['message'],
                         'success')
        assert response1.status_code == 200
    ...
    def test_party_keys(self):
        ...
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_name_keys), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_edit_party_name_value(self):
        ...
        response1 = self.client.put(
            '/api/v2/parties/1', data=json.dumps(party_name_value), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response1.data.decode())
    ...
    def test_edit_party_hqAddress_value(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_token())
        response1 = self.client.put(
            '/api/v2/parties/1', data=json.dumps(party_hqAddress_value), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response1.data.decode())
    ...
    def test_edit_party_logoUrl_value(self):
        ...
        response = self.client.post(
            ...
            headers=self.get_token())
        response1 = self.client.put(
            '/api/v2/parties/1', data=json.dumps(party_logoUrl_value), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response1.data.decode())
        self.assertEqual(result['message'], 'logoUrl is in the wrong format!')
        assert response1.status_code == 400
    ...
    def test_edit_party_keys(self):
        ...
        response = self.client.put(
            '/api/v2/parties/1', data=json.dumps(party_name_keys), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid name key')
        assert response.status_code == 400
    ...
    def test_party_nameValue(self):
        ...
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_name_value), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_party_hqAddressValue(self):
        ...
        response = self.client.post(
            '/api/v2/parties', data=json.dumps(party_hqAddress_value), content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
