...
class TestOffice(BaseTest):
	...
	def test_create_office(self):
		...
		response = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(create_office2), content_type='application/json')
	...
	def test_office_keys(self):
		...
		response = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(office_keys), content_type='application/json')
		result = json.loads(response.data.decode())
	...
	def test_get_offices(self):
		...
		response1 = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(create_office2), content_type='application/json')
		response = self.client.get(
			'/api/v2/auth/offices', data=json.dumps(get_office), content_type='application/json')
		result = json.loads(response.data.decode())
	...
	def test_unexisting_offices(self):
		...
		response = self.client.get(
			'/api/v2/auth/offices', content_type='application/json')
	...
	def test_get_office(self):
		...
		response1 = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(create_office2), content_type='application/json')
		response = self.client.get(
			'/api/v2/auth/offices/1', data=json.dumps(get_office), content_type='application/json')
		result = json.loads(response.data.decode())
		self.assertEqual(result['message'],
			'success')
		assert response.status_code == 200
	...
	def test_office_categoryValue(self):
		...
		response = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(office_category), content_type='application/json')
		result = json.loads(response.data.decode())
	...
	def test_office_nameValue(self):
		...
		response = self.client.post(
			'/api/v2/auth/offices', data=json.dumps(office_name), content_type='application/json')
		result = json.loads(response.data.decode())
		self.assertEqual(result['message'], 'input is in wrong format')
		assert response.status_code == 400
