...
class TestUsersAccount(BaseTest):
	...
	def test_account_emailValue(self):
		...
		response = self.client.post(
			'/api/v3/users', data=json.dumps(email_value), content_type='application/json')
		result = json.loads(response.data.decode())
	...
	def test_account_phoneValue(self):
		...
		response = self.client.post(
			'/api/v3/users', data=json.dumps(phone_value), content_type='application/json')
		result = json.loads(response.data.decode())
	...
	def test_account_passportValue(self):
		...
		response = self.client.post(
			'/api/v3/users', data=json.dumps(passport_value), content_type='application/json')
		result = json.loads(response.data.decode())
